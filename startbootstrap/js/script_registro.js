...
var onComplete = function() {
    ...
    h1.appendChild(document.createTextNode('Gracias ' + questions[1].answer + ' por registrarte en KingdomTV!'))
    setTimeout(function() {
      register.parentElement.appendChild(h1)
      setTimeout(function() { h1.style.opacity = 1 }, 50)
    }, 1000)
    //Aqui poner un codigo para que redirija a la pagina del logins
...
;(function(questions, onComplete) {
    ...
    function putQuestion() {
        ...
        previousButton.className = position ? 'ion-android-arrow-back' : 'ion-at'
